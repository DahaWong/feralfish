...
message_handlers = [
    MessageHandler(Filters.chat_type.groups & Filters.update.edited_message & Filters.regex(r'#(?:上电视|野鱼屏幕|分享发现)'), send_to_channel),
    MessageHandler(Filters.chat_type.groups & Filters.regex(r'#(?:上电视|野鱼屏幕|分享发现)'), send_to_channel)
]
